...
Cordova:
```bash
cordova plugin add https://github.com/sopraux/cordova-plugin-photoviewer.git
```

Ionic 2:
```bash
$ ionic cordova plugin add https://github.com/sopraux/cordova-plugin-photoviewer.git
